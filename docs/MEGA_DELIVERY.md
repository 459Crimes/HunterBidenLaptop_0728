...
No MEGA account export, server log, or original folder hash from August 2021 is published here. Whether anyone downloaded before the author is **unknown**; the project record only establishes the author as the **first known** downloader.

Continuity from that download to the current 480,039-path inventory is **author working-copy custody**, later hashed into PostgreSQL source 2.
